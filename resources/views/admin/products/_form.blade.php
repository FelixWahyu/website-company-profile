        ...
        <div class="md:col-span-2 space-y-6">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="6" required
                    class="mt-1 block w-full border border-gray-500 rounded-lg shadow-md focus:ring-blue-500 focus:border-blue-500">{{ old('description', $product->description ?? '') }}</textarea>
                @error('description')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                @enderror
            </div>
                ...
                <div class="pt-6">
                    <label for="is_promo" class="flex items-center">
                        <input type="checkbox" id="is_promo" name="is_promo" value="1"
                            ...
                            class="h-5 w-5 text-blue-600 border border-gray-500 rounded-md shadow-md focus:ring-blue-500">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="file" id="image" name="image"
                    class="mt-1 block w-full text-sm border border-gray-500 p-1 shadow-md rounded-lg text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
                    accept="image/*">
                @error('image')
                    <span class="text-red-500 text-xs">{{ $message }}</span>
                @enderror
