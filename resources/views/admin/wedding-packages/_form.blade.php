...
<div class="space-y-4">
    ...
    <div>
        ...
        <textarea name="features" id="features" rows="5" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm"
    ...
    <div>
        ...
        <textarea name="description" id="description" rows="4"
            class="block w-full mt-1 border-gray-300 rounded-md shadow-sm" required>{{ old('description', $weddingPackage->description ?? '') }}</textarea>
    </div>
    <div>
...
<div class="mt-6">
    <button type="submit"
        class="px-4 py-2 text-white bg-indigo-600 rounded-md hover:bg-indigo-700">{{ $submitText ?? 'Simpan' }}</button>
