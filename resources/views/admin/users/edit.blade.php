<x-admin-layout>
    <x-slot name="header">
        <h2 class="text-3xl font-semibold text-gray-800 mb-6">Edit User {{ $user->name }}</h2>
    </x-slot>

    <div class="container mx-auto px-6 py-2">

        <div class="bg-white rounded-lg p-2">
            <form action="{{ route('admin.products.update', $user) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
