    ...
    <div class="p-6 bg-white border-b border-gray-200">
        <div class="flex justify-end mb-4">
            <a href="{{ route('admin.galleries.create') }}"
                class="px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700">+ Tambah Galeri</a>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 border-t border-gray-300 p-4">
