        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div
                    ...
                    <img src="https://images.unsplash.com/photo-1583258292688-d021e9505a96?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
                        alt="Lorong Supermarket" class="w-full h-64 object-cover">
                    <div class="p-8">
                        ...
                        <a href="{{-- route('supermarket.index') --}}"
