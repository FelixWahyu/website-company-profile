    ...
    <div>
        ...
        <div class="flex flex-1 flex-col lg:pl-72">
            ...
            <header class="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white shadow">
                <button type="button" class="border-r border-gray-200 px-4 text-gray-500 focus:outline-none lg:hidden">
            ...
            <main class="flex-1">
                <div class="py-6">
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <h1 class="text-2xl font-semibold leading-tight text-gray-900">{{ $header ?? '' }}</h1>
                    </div>
