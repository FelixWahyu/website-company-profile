                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.testimonials.index') }}"
                            class="group flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.testimonials.*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor"
                                class="mr-3 size-6 {{ request()->routeIs('admin.testimonials.*') ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500' }}">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.users.index') }}"
                            class="group flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.users.*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor"
                                class="mr-3 size-6 {{ request()->routeIs('admin.users.*') ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500' }}">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.products.index') }}"
                            class="group flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.products.*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.categories.index') }}"
                            class="group flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.categories.*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor"
                    ...
                    <li>
                        <a href="{{ route('admin.promo-slides.index') }}"
                            class="group flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.promo-slides.*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor"
                    ...
                    <li>
                        <a href="{{ route('admin.wedding-packages.index') }}"
                            class="group flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.wedding-packages.*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="mr-3 size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.galleries.index') }}"
                            class="group flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-md {{ request()->routeIs('admin.galleries.*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="mr-3 size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.settings.index') }}"
                            class="group flex items-center px-4 py-2.5 space-x-3 text-sm font-medium rounded-md {{ request()->routeIs('admin.settings.*') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="mr-3 size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
